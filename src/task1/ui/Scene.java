...
public class Scene extends JFrame {
    ...
    public void init(){
        ...
        try {
            tabacoIcon = new JLabel(new ImageIcon(ImageIO.read(new File("D:\\IdeaProjects\\Parallel\\Parallel\\src\\task1\\res\\tabaco\\icons8-tobacco-pouch-50.png"))));
            paperIcon = new JLabel(new ImageIcon(ImageIO.read(new File("D:\\IdeaProjects\\Parallel\\Parallel\\src\\task1\\res\\paper\\icons8-paper-50.png"))));
            matchesIcon = new JLabel(new ImageIcon(ImageIO.read(new File("D:\\IdeaProjects\\Parallel\\Parallel\\src\\task1\\res\\matches\\icons8-matches-50.png"))));
        } catch (IOException e) {
